//////////////////////////////////////////////////////////////////////////////
// SupplierBasedCompletableFuture.java
//////////////////////////////////////////////////////////////////////////////
...
{
    private CompletableFuture<Supplier<T>> supplier;
    private CompletableFuture<T>           future;

    public
    SupplierBasedCompletableFuture(CompletableFuture<Supplier<T>> source)
    {
        supplier = source;
        future   = null;
    }
    ...
    public static <T> SupplierBasedCompletableFuture<T>
    supplyAsync(Supplier<Supplier<T>> supplier)
    {
        return new SupplierBasedCompletableFuture<>(CompletableFuture.supplyAsync(supplier));
    }
    
    protected synchronized CompletableFuture<T>
    getFuture()
    {
        try
        {
            if (future ==  null)
             future = CompletableFuture.supplyAsync(supplier.get());
